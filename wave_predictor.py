...
print('Based on averages of countries which have had fourth wave, India will have the peak of the fourth wave %.f days after the 3rd wave with a standard deviation of %.f days' % (mean,standard_Deviation))
...
#--------------------------------------------------------------------------------------------------------------------------------
#Future plans- A more advanced model pipeline for predicting the next wave based on Gaussians and GMMs will soon be developed
#--------------------------------------------------------------------------------------------------------------------------------
